...
const privacy = () => {
  return (
    <>
      <h1>Privacy Policy for timexonesyncer</h1>

      <p>
        At timexonesyncer, accessible from https://timexonesyncer.tech/#, one of
        ...
        timexonesyncer and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in timexonesyncer. This policy is not applicable
      ...
      <p>
        timexonesyncer follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, timexonesyncer uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of timexonesyncer.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on timexonesyncer, which are sent
      ...
      <p>
        Note that timexonesyncer has no access to or control over these cookies
      ...
      <p>
        timexonesyncer's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        timexonesyncer does not knowingly collect any Personal Identifiable
