...
export function Benefit1SVG() {
  return (
    <svg
      ...
      viewBox="4 8 845 818"
      className="sm:block max-w-md sm:max-h-100"
    ...
    >
      ...
      <ellipse
        ...
        opacity=".1"
      />
      <circle cx="357.087" cy="282.184" r="30.759" fill="#6c63ff" />
      <path
        fill="#3f3d56"
        stroke="#3f3d56"
        strokeMiterlimit={10}
      ...
      <circle cx="444.402" cy="197.806" r="30.759" fill="#6c63ff" />
      <path
        fill="#3f3d56"
        stroke="#3f3d56"
        strokeMiterlimit={10}
      ...
      />
      <ellipse cx="254.678" cy="262.848" rx="14.579" ry="3.016" opacity=".1" />
      <path
